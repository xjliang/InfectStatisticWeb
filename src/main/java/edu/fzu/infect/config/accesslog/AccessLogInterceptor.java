package edu.fzu.infect.config.accesslog;

import edu.fzu.infect.utils.AddressIpUtils;
...
public class AccessLogInterceptor implements HandlerInterceptor {
    ...
    /**
     * 进入 SpringMVC 的 Controller 之前开始记录日志实体
     */
    @Override
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object o,
        ...
        // 设置访问者(这里暂时写死）
        // 因为不同的应用可能将访问者信息放在 session 里面，有的通过 request 传递，
        // 总之可以获取到，但获取的方法不同
